...
title @a subtitle ["",{"translate":"周期性的在每个玩家头顶召唤火焰冲击","color": "gray"}]
...
tellraw @a ["",{"translate":"每过一段时间在每个玩家头顶召唤一个向下发射的火焰冲击","color": "white"}]
tellraw @a ["",{"translate":"-死斗中无效","color": "white"}]
