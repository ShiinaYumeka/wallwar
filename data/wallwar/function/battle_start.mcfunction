...
scoreboard players set @a revive_left 1
...
tellraw @a ["",{"translate":"·难度将改为普通，死亡后掉落所有物品","color": "white"}]
tellraw @a ["",{"translate":"·每位玩家有1次阵亡后传送至地图中心复活的机会","color": "white"}]
tellraw @a ["",{"translate":"·之后需使用复生之星复活队友（每次最多消耗3个）","color": "white"}]
tellraw @a ["",{"translate":"·击杀玩家会额外掉落一个玩家头颅和一个速食金苹果","color": "white"}]
tellraw @a ["",{"translate":"·玩家因其他方式死亡会额外掉落一个凋零骷髅头颅","color": "white"}]
tellraw @a ["",{"translate":"·TNT矿车引信时间延长，有更多反应时间","color": "white"}]
tellraw @a ["",{"translate":"·战斗阶段不再对地下施加凋零；缩圈后Y0-30与Y-64-0将分别受到凋零I","color": "white"}]
