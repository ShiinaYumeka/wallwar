...
#剔除已拥有附魔
execute if data storage minecraft:temp temp.temp[0] run function wallwar:command/add/fix/find

#属性均拥有时随机升一级
execute unless data storage minecraft:temp temp.ench[0] run return run function wallwar:command/add/fix/add/main
...
#选定随机的附魔
function wallwar:command/add/fix/id with storage minecraft:temp temp.random
