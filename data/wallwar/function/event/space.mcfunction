...
tellraw @a ["",{"translate":"所有玩家的跳跃力度提升40%","color": "white"}]
tellraw @a ["",{"translate":"“爷爷奶奶可高兴了，给我爱吃的致密V重锤”","color": "gray"}]
tellraw @a ["",{"translate":"-----------------------------------------------------","color": "gray"}]



execute as @a[team=!sp] run attribute @s jump_strength modifier add event_space 0.4 add_multiplied_total
#execute as @a[team=!sp] run effect give @s jump_boost infinite 3 true