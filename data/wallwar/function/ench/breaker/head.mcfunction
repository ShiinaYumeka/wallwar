...
execute unless items entity @s armor.head #enchantable/armor run return fail
execute if items entity @s armor.head #enchantable/armor[unbreakable] run return fail
execute if items entity @s armor.head #enchantable/armor[damage~{durability:{max:180}}] run return fail

item replace entity 0-0-0-0-1 container.0 from entity @s armor.head
execute on attacker store result score #breaker temp run function wallwar:ench/breaker/atker
