...
item replace entity @s armor.head with wither_skeleton_skull[attribute_modifiers=[{id:"leather_head",amount:3,operation:"add_value",type:"armor",slot:"head"},{id:"leather_head",amount:2,operation:"add_value",type:"armor_toughness",slot:"head"}],enchantments={protection:8,vanishing_ench:1,binding_curse:1},unbreakable={}]
