...
execute store result score #boss_team temp if entity @a[team=red]
execute store result score #other_team temp if entity @a[team=!sp,team=!red]

execute as @a[team=red] run function wallwar:boss/change
...
scoreboard players set @a[team=red] recipe 1
