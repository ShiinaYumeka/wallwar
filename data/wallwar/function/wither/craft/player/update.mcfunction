...
execute store success score #temp temp as @p[tag=wither_pickaxe,distance=..1,team=!sp,tag=FIGHT,gamemode=!spectator] run function wallwar:wither/craft/player/ench3
