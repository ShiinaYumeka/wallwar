...
execute if score #wither_skill_explode time matches 1000.. run function wallwar:wither/skill/explode/use
...
execute if score #wither_skill_fall time matches 160.. run function wallwar:wither/skill/fall/use


execute if entity @s[tag=wither_skill_pig] run scoreboard players add #wither_skill_pig time 1
execute if score #wither_skill_pig time matches 1500.. run function wallwar:wither/skill/pig/use
