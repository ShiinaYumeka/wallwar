...
title @a subtitle ["",{"translate":"在每位玩家附近随机召唤凋零骷髅","color": "gray"}]
...
tellraw @a ["",{"translate":"在每位玩家附近随机召唤凋零骷髅","color": "white"}]
tellraw @a ["",{"translate":"“我们是不是来错地方了，这里好像不是地狱堡垒”","color": "gray"}]
tellraw @a ["",{"translate":"-----------------------------------------------------","color": "gray"}]

execute as @a[tag=FIGHT,team=!sp,gamemode=!spectator] at @s run function wallwar:event/skeleton/cast
