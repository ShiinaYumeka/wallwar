...
execute as 0-0-0-0-1 at @s run setblock ~3 ~1 ~3 red_shulker_box{Items:[{id:"enchanting_table",Slot:0b,count:1b},{id:"sugar_cane",Slot:1b,count:15b},{id:"wheat_seeds",Slot:2b,count:32b},{id:"item_frame",Slot:3b,count:2b},{id:"water_bucket",Slot:4b,count:1b},{id:"oak_sapling",Slot:5b,count:16b},{id:"red_banner",Slot:6b,count:1b},{id:"leather",Slot:7b,count:16b},{id:"compass",Slot:8b,count:2b,components:{custom_data:{"mine_compass":1b,"wallwar_item":1b},custom_name:{"translate":"矿洞指南针","color":"light_purple","italic":false},lore:[{"translate":"按Q丢出后将自己随机传送至内Y<0的随机位置","color":"white","italic":false},{"translate":"只能在发育阶段使用","color":"white","italic":false},{"translate":"*人走过的地方，就变成了路。","color":"gray","italic":false}]}}]} replace
execute as 0-0-0-0-1 at @s run setblock ~3 ~1 ~-3 light_blue_shulker_box{Items:[{id:"enchanting_table",Slot:0b,count:1b},{id:"sugar_cane",Slot:1b,count:15b},{id:"wheat_seeds",Slot:2b,count:32b},{id:"item_frame",Slot:3b,count:2b},{id:"water_bucket",Slot:4b,count:1b},{id:"oak_sapling",Slot:5b,count:16b},{id:"light_blue_banner",Slot:6b,count:1b},{id:"leather",Slot:7b,count:16b},{id:"compass",Slot:8b,count:2b,components:{custom_data:{"mine_compass":1b,"wallwar_item":1b},custom_name:{"translate":"矿洞指南针","color":"light_purple","italic":false},lore:[{"translate":"按Q丢出后将自己随机传送至内Y<0的随机位置","color":"white","italic":false},{"translate":"只能在发育阶段使用","color":"white","italic":false},{"translate":"*人走过的地方，就变成了路。","color":"gray","italic":false}]}}]} replace
execute as 0-0-0-0-1 at @s run setblock ~-3 ~1 ~-3 lime_shulker_box{Items:[{id:"enchanting_table",Slot:0b,count:1b},{id:"sugar_cane",Slot:1b,count:15b},{id:"wheat_seeds",Slot:2b,count:32b},{id:"item_frame",Slot:3b,count:2b},{id:"water_bucket",Slot:4b,count:1b},{id:"oak_sapling",Slot:5b,count:16b},{id:"lime_banner",Slot:6b,count:1b},{id:"leather",Slot:7b,count:16b},{id:"compass",Slot:8b,count:2b,components:{custom_data:{"mine_compass":1b,"wallwar_item":1b},custom_name:{"translate":"矿洞指南针","color":"light_purple","italic":false},lore:[{"translate":"按Q丢出后将自己随机传送至内Y<0的随机位置","color":"white","italic":false},{"translate":"只能在发育阶段使用","color":"white","italic":false},{"translate":"*人走过的地方，就变成了路。","color":"gray","italic":false}]}}]} replace
execute as 0-0-0-0-1 at @s run setblock ~-3 ~1 ~3 yellow_shulker_box{Items:[{id:"enchanting_table",Slot:0b,count:1b},{id:"sugar_cane",Slot:1b,count:15b},{id:"wheat_seeds",Slot:2b,count:32b},{id:"item_frame",Slot:3b,count:2b},{id:"water_bucket",Slot:4b,count:1b},{id:"oak_sapling",Slot:5b,count:16b},{id:"yellow_banner",Slot:6b,count:1b},{id:"leather",Slot:7b,count:16b},{id:"compass",Slot:8b,count:2b,components:{custom_data:{"mine_compass":1b,"wallwar_item":1b},custom_name:{"translate":"矿洞指南针","color":"light_purple","italic":false},lore:[{"translate":"按Q丢出后将自己随机传送至内Y<0的随机位置","color":"white","italic":false},{"translate":"只能在发育阶段使用","color":"white","italic":false},{"translate":"*人走过的地方，就变成了路。","color":"gray","italic":false}]}}]} replace
