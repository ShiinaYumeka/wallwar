...
give @s diamond_sword[custom_model_data={floats:[1]},enchantments={"sharpness": 5,"bigkiller": 3,"vanishing_ench": 1},custom_name={"translate":"杀戮","italic": false,"color": "dark_red","bold": true},lore=[{"translate":"BOSS专属武器","italic": false,"color": "red"},{"translate":"*星芒一闪身随至，铁幕未落首已飞。","italic": false,"color": "gray"},{"translate":"","italic": false,"color": "dark_green"},{"translate":"在主手时：","italic": false,"color": "gray"},{"translate":" 7 攻击伤害","italic": false,"color": "dark_green"},{"translate":" 1.8 攻击速度","italic": false,"color": "dark_green"},{"translate":"","italic": false,"color": "dark_green"},{"translate":"手持时：","italic": false,"color": "gray"},{"translate":"+20% 移动速度","italic": false,"color": "blue"}],attribute_modifiers=[{"id": "diamond_sword","type": "attack_damage","amount": 6,"operation": "add_value","slot": "mainhand"},{"id": "diamond_sword","type": "attack_speed","amount": -2.2,"operation": "add_value","slot": "mainhand"},{"id": "diamond_sword","type": "movement_speed","amount": 0.1,"operation": "add_multiplied_base","slot": "hand"}],max_damage=32767]
