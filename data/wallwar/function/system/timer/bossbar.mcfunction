...
execute store result bossbar minecraft:gauge7 value run scoreboard players get GAME time
execute store result bossbar minecraft:gauge8 value run scoreboard players get GAME time
