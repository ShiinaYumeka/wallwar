...
execute as @e[type=item_frame,nbt={Item:{components:{"minecraft:custom_data":{building_spawner:1b}}}}] at @s if entity @s[y=-64,dy=213] run function wallwar:build/spawner/main
