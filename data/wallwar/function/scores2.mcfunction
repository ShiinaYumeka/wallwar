...
scoreboard objectives remove wither_horn_use
scoreboard objectives remove command_book_use
scoreboard objectives remove fishing_use
scoreboard objectives remove egg_user
scoreboard objectives remove command_block_give
scoreboard objectives remove command_block_timer
scoreboard objectives remove konpaku
scoreboard objectives remove ender_used
scoreboard objectives remove escape_timer
...
bossbar remove gauge
bossbar remove gauge2

bossbar remove gauge3
bossbar remove gauge4
bossbar remove gauge5
bossbar remove gauge6
