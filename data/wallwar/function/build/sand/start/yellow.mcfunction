...
tag @a[team=yellow] add lowY

function wallwar:system/wall/red_blue
...
fill ~-300 121 ~1 ~-1 150 ~1 minecraft:iron_ore replace bedrock
...
fill ~-1 121 ~300 ~-1 150 ~1 minecraft:iron_ore replace bedrock
forceload remove ~ ~300 ~ ~
