...
tellraw @s [{"translate": "*你献出了足够的祭品，你能感受到祂的喜悦。","color": "gray"}]

execute store result score #temp temp run data get entity @s equipment.chest.components."minecraft:enchantments"."minecraft:blast_protection"
...
execute store result entity 0-0-0-0-1 item.components."minecraft:enchantments"."minecraft:blast_protection" int 1 run scoreboard players get #temp temp
