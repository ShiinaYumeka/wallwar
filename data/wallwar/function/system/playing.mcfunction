...
execute if score GAME_PRO time matches 10 if entity @s[advancements={wallwar/misc/ender_chest=true,wallwar/misc/ender_delete=false}] if items entity @s enderchest.* enchanted_golden_apple[custom_data~{"death_fight_end":1b}] run function wallwar:system/phase/dead_noapple
