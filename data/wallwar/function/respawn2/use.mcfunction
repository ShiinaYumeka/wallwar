...
execute as @a[tag=respawn_target] run function wallwar:respawn2/main
execute if entity @a[tag=respawn_target] as @a[tag=respawn_user] run function wallwar:respawn2/user
execute unless entity @a[tag=respawn_target] run return run function wallwar:respawn2/fail
