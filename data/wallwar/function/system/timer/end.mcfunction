...
execute if score GAME_PRO time matches 1 run return run function wallwar:system/phase/battle_start

execute if score GAME_PRO time matches 2 run return run function wallwar:system/phase/circle_1

execute if score GAME_PRO time matches 3 run return run function wallwar:system/phase/circle_2
...
execute if score GAME_PRO time matches 4 run return run function wallwar:system/phase/death_fight
...
execute if score GAME_PRO time matches 5 run return run function wallwar:system/phase/team_upgrade
