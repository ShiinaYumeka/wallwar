...
item replace entity @s armor.feet with leather_boots[attribute_modifiers=[{id:"leather_boot",amount:3,operation:"add_value",type:"armor",slot:"feet"},{id:"leather_boot",amount:2,operation:"add_value",type:"armor_toughness",slot:"feet"}],enchantments={protection:2,vanishing_ench:1,binding_curse:1},dyed_color=[1,0,0],unbreakable={},max_damage=9999]

item replace entity @s armor.legs with leather_leggings[attribute_modifiers=[{id:"leather_leggings",amount:6,operation:"add_value",type:"armor",slot:"legs"},{id:"leather_leggings",amount:2,operation:"add_value",type:"armor_toughness",slot:"legs"}],enchantments={protection:2,vanishing_ench:1,binding_curse:1},dyed_color=[1,0,0],unbreakable={},max_damage=9999]

item replace entity @s armor.chest with leather_chestplate[attribute_modifiers=[{id:"leather_chest",amount:8,operation:"add_value",type:"armor",slot:"chest"},{id:"leather_chest",amount:2,operation:"add_value",type:"armor_toughness",slot:"chest"}],enchantments={protection:2,vanishing_ench:1,binding_curse:1},dyed_color=[1,0,0],unbreakable={},max_damage=9999]
